...
<div class="product-list" id="product-list">
    ...
    <div class="product-item" data-category="cachorros" data-type="alimento">
        ...
        <div class="product-title">Gaiola para Pássaros</div>
...
<div class="product-list" id="product-list">
    ...
    <div class="product-item" data-category="gatos" data-type="brinquedos">
        <img src="https://images.petz.com.br/fotos/1672403149016.jpg" alt="Produto 5">
...
<script>
    ...
    function filterProducts() {
        ...
        products.forEach(product => {
            ...
            if ((category === 'todas' || productCategory === category) && (type === 'todos' || productType === type)) {
