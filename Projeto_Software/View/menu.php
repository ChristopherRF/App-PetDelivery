...
<body>
    ...
    <div class="container">
        ...
        <div class="right-div">
            ...
            <p style="font-size:2.3vh;">Esta aqui é a opção de resgate ao animal perdido. Você dono do animal, deverá dizer o nome do animal,
                 a raça dele, sua cor, e uma foto dele, e adicione também o ultimo local que você esteve com seu pet.</p>
        </div>
    </div>
